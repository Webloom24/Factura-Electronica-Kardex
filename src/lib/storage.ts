...
export const DEFAULT_EMISOR: Emisor = {
  ...
  resolution: "Res. XXXXXX · Rango: 0001 – 1000 · Vigencia: 2026 – 2027",
};
...
export function createInvoice(
  inv: Omit<Invoice, "id" | "created_at">,
): Invoice {
...
export function calcInvoiceTotals(
  items: Pick<InvoiceItem, "line_subtotal" | "line_vat" | "line_total">[],
) {
...
export function importData(raw: unknown): { ok: boolean; error?: string } {
  ...
  if (!Array.isArray(d.products))
    return { ok: false, error: 'Falta "products"' };
  if (!Array.isArray(d.customers))
    return { ok: false, error: 'Falta "customers"' };
  if (!Array.isArray(d.invoices))
    return { ok: false, error: 'Falta "invoices"' };
  if (typeof d.counter !== "number")
    return { ok: false, error: 'Falta "counter"' };
...
export const SEED_PRODUCTS: ProductSeed[] = [
  ...
  {
    name: "ILUMINADOR MARMOLADO MELU",
    sku: "MEL-122",
    unit: "UND",
    price_sale: 14100,
    vat_rate: 0.19,
  ...
  {
    name: "GEL DE LIMPIEZA FACIAL RUBY SKIN",
    sku: "MEL-125",
    unit: "UND",
    price_sale: 15900,
    vat_rate: 0.19,
  ...
  {
    name: "CREMA HIDRATANTE FACIAL RUBY SKIN",
    sku: "MEL-126",
    unit: "UND",
    price_sale: 15000,
    vat_rate: 0.19,
  ...
  // ── TRENDY ─────────────────────────────────────────────────
  {
    name: "CREMA FACIAL REPARADORA NOCTURNA TRENDY",
    sku: "CAM-2205",
    unit: "UND",
    price_sale: 13000,
    vat_rate: 0.19,
  ...
  {
    name: "BASE TRULY MATE L.A COLORS",
    sku: "CAM-2206",
    unit: "UND",
    price_sale: 15000,
    vat_rate: 0.19,
  ...
  {
    name: "CORRECTOR REBEL GIRL TRENDY",
    sku: "CAM-2208",
    unit: "UND",
    price_sale: 10000,
    vat_rate: 0.19,
  ...
  {
    name: "KIT DE CEJAS BAKERY TRENDY",
    sku: "CAM-2216",
    unit: "UND",
    price_sale: 15000,
    vat_rate: 0.19,
  ...
  {
    name: "DELINEADOR EN PLUMON TRENDY",
    sku: "CAM-2217",
    unit: "UND",
    price_sale: 6000,
    vat_rate: 0.19,
